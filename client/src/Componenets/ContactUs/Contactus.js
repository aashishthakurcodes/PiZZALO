    ...
    <div  id="contact">
      ...
      <div className='cont_container' id="contact">
        ...
        <div className='form_cont'>
          <h1 style={{ color: "orange", fontFamily: "inter" }} className="about_Heading">Contact Us</h1>
          <form>
            ...
            <div className='sub_btn'>
              <button className='order_btn' onClick={handleSubmit}>Submit</button>
            </div>
          </form>
        </div>
        <div className='img_conty'>
